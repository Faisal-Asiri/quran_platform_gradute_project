...
<html dir="rtl">
<head>
	<title> منصة الكتاب المبين - قائمة السورالتفسير</title>
...
<header class="opener">
  <div class="wrapper">
      <h1> قائمة سور  القرآن الكريم وتفسيرها
</h1>
<h2>اختر سورة لعرض التفسير الميسر</h2>
  </div>
</header>
...
echo"<tr><td>";
echo "<a id=sour href='tafseer.php?ID={$row['sura_no']}'>" . $row["sura_name_ar"]. "</a>          ";
